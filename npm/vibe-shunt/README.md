...
```bash
npx vibe-shunt --yes
npx vibe-shunt --repo chllming/shunt --version core-v0.2.0 --install-dir ~/.local/bin
...
This package installs the public open-core release. Beyond Work's private Website3, Doppler, Steward, Manual Swarm, and SwarmFS integrations are intentionally not shipped through npm.
